...
func ResolveTaskResources(ts *v1alpha1.TaskSpec, taskName string, kind v1alpha1.TaskKind, inputs []v1alpha1.ResourceBinding, outputs []v1alpha1.ResourceBinding, gr GetResource) (*ResolvedTaskResources, error) {
